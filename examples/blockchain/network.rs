...
use bankless_bft::{NodeIndex, Recipient, TaskHandle};
...
const BANKLESS_PROTOCOL_NAME: &str = "/banklessbft/test/1";

pub(crate) type NetworkData =
    bankless_bft::NetworkData<Hasher256, Data, Signature, PartialMultisignature>;
...
#[async_trait::async_trait]
impl bankless_bft::Network<Hasher256, Data, Signature, PartialMultisignature> for Network {
    ...
    > {
        ...
        let mut swarm = {
            ...
            let rq_rp = RequestResponse::new(
                GenericCodec {},
                iter::once((BANKLESS_PROTOCOL_NAME.as_bytes().to_vec(), protocol_support)),
                rr_cfg,
            );
