...
<p align="center">
  <a href="https://bankless.org" target="_blank">
  <img src="https://bankless.org/wp-content/uploads/A0_logotype_bft_dark.jpg" />
  </a>
</p>

### Overview

BanklessBFT is an asynchronous and Byzantine fault tolerant consensus protocol aimed
...
This repository contains a Rust implementation of BanklessBFT that offers a convenient
...
of the [Bankless blockchain][bankless-node-link].
...
- Asynchronous liveness is an important theoretical property and there is a lot of technical
  sophistication that comes in the design of BanklessBFT in order to achieve it, however on the practical
  ...
  seriously and plan to add randomness to BanklessBFT in one of the future releases. We decided to go
...
- Import BanklessBFT in your crate
  ```toml
  [dependencies]
  bankless-bft = "^0.8"
  ```
- BanklessBFT requires user to provide it with an implementation of the following traits:
...
Currently we provide two basic examples of running BanklessBFT. The first one: `dummy-honest` implements a committee member that is not
...
The second example: `blockchain` is meant for benchmarking BanklessBFT in the blockchain setting. It implements a simple round-robin blockchain assuming honest participation. The simplest way to run it is to use the provided script as follows (assuming we start in the root directory)
...
BanklessBFT is licensed under the terms of the the Apache License 2.0.

### Funding

The implementation in this repository is funded by [Bankless Foundation][webpage-link].

[//]: ### "badges"
[dataio-link]: https://hangsiahong.github.io/BanklessBFT/bankless_bft_api.html#311-dataio
[network-link]: https://hangsiahong.github.io/BanklessBFT/bankless_bft_api.html#312-network
[keybox-link]: https://hangsiahong.github.io/BanklessBFT/bankless_bft_api.html#313-keybox
[crate-image]: https://img.shields.io/crates/v/bankless-bft.svg
[crate-link]: https://crates.io/crates/bankless-bft
[docs-image]: https://docs.rs/bankless-bft/badge.svg
[docs-link]: https://docs.rs/bankless-bft
[build-image]: https://github.com/hangsiahong/BanklessBFT/workflows/CI/badge.svg
[build-link]: https://github.com/hangsiahong/BanklessBFT/actions?query=workflow%3ACI
[license-image]: https://img.shields.io/badge/license-Apache2.0-blue.svg
[license-link]: https://github.com/hangsiahong/BanklessBFT/blob/main/LICENSE
[rustc-image]: https://img.shields.io/badge/rustc-stable-blue.svg
[//]: ### "general links"
[reference-link]: https://hangsiahong.github.io/BanklessBFT/index.html
[paper-link]: https://arxiv.org/abs/1908.05156
[old-paper-link]: https://arxiv.org/abs/1810.05256
[bankless-node-link]: https://github.com/hangsiahong/bankless-node
[webpage-link]: https://bankless.org
