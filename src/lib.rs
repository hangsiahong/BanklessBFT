//! Implements the Bankless BFT Consensus protocol as a "finality gadget". The [Member] struct
...
///
/// BanklessBFT internally calls [`DataProvider::get_data`] whenever a new unit is created and data needs to be placed inside.
///
/// We refer to the documentation https://hangsiahong.github.io/BanklessBFT/bankless_bft_api.html for a discussion
